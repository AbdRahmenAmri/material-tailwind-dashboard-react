...
import { isLoged, login } from "@/services/Auth";
import useLogedIn from "@/hooks/use_loged_in";

export default function Login() {
  
  useTitle('Login | AI Tailor')
      ...
      <div className="container h-full px-6 py-24">
        ...
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
            <form>
              <h1 className="text-center text-gray-700 text-3xl mb-4">Login</h1>
              <Input
                id={"email"}
              ...
              <div className="mb-6 flex items-center justify-end">
                <Link
                  to={Links.forget_password}
                  className="text-gray-700 transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
                >
                  Forgot password?
                </Link>
              </div>
